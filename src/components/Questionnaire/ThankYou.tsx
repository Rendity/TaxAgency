...
const ThankYou = () => {
  return (
    <div className="max-w-2xl mx-auto text-center py-12">
      ...
      <p className="text-xl text-gray-600">Wir haben die Angaben erhalten und Nextcloud eingerichtet. Mit Klick auf "Passwort vergessen?" kann das Passwort für den Account festgelegt werden.</p>
      <a
      ...
      <div className="mt-8">
        ...
        <div className="mt-6">
          <h4 className="text-lg font-medium text-gray-700 mb-3">Detaillierte Anleitungen für Einrichtung</h4>
          <p>Bitte ziehen Sie diese bei Erhalt des Willkommens-Mail heran.</p>
